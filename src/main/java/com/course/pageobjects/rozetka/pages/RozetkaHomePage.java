...
public class RozetkaHomePage extends BasePage {
    ...
    @FindBy(xpath = "//*[@class='menu-categories__link' and @href='https://rozetka.com.ua/ua/telefony-tv-i-ehlektronika/c4627949/']")
    private WebElement mobileDevicesCategory;

    @FindBy(xpath = "//*[@class='menu__link' and @href='https://rozetka.com.ua/ua/photo/c80001/']")
    private WebElement hiddenMobileDevicesCategory;
    ...
    public RozetkaPhotoCamerasPage openMobileDevicesCategory(){
        waitUtils.waitUntilElementClickable(mobileDevicesCategory, 10);
        Actions actions = new Actions(driver);
        actions.moveToElement(mobileDevicesCategory).build().perform();
        waitUtils.waitUntilElementClickable(hiddenMobileDevicesCategory, 10);
        hiddenMobileDevicesCategory.click();
        return new RozetkaPhotoCamerasPage(driver);
